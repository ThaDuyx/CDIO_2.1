...
public class Game {
    ...
    public static void main(String[] args) {
        ...
        //opsætning af sprogkode slutter her. Man kan nu vha. getString-metoden i objektet messages, referere til bestemte linjer i vores teks-filer.
